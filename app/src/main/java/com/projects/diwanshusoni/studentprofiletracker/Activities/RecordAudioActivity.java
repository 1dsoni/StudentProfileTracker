...
public class RecordAudioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getBooleanExtra("StartRecording", false)){
            startRecord();
        }
    }
    ...
    private void startRecord() {
        if(checkPermission()) {
            ...
            AudioSavePathInDevice =
                    Environment.getExternalStorageDirectory().getAbsolutePath() + "/" +"campusBuddy/"+
                            Calendar.getInstance().getTimeInMillis() + "AudioRecording.3gp";
    ...
    /*public String CreateRandomAudioFileName(int string){
        ...
        int i = 0 ;
        while(i < string ) {
            stringBuilder.append(RandomAudioFileName.Calendar.getInstance().getTimeInMillis();
            i++ ;
        }
